...
(function(window, document, undefined) {
  ...
  FlowFile.prototype = {
    ...
    bootstrap: function() {
      ...
      var chunks = Math.max(round(this.size / this.flowObj.opts.chunkSize), 1);
  ...
  function webAPIFileRead(fileObj, startByte, endByte, fileType, chunk) {
    ...
    chunk.readFinished(
      fileObj.file[function_name](startByte, endByte, fileType)
    );
  }
